...
@add_start_docstrings(
    """Camembert Model transformer with the option to add multiple flexible heads on top.""",
    CAMEMBERT_START_DOCSTRING,
)
class CamembertAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, CamembertPreTrainedModel):
    head_types = [
        "classification",
